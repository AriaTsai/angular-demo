import { BoSvgLink } from '@shared/bo-svg-tree/bo-svg-link/bo-svg-link-builder';
import { ClusterNode, Edge, Node } from '@swimlane/ngx-graph';
import { BoSvgNode } from './bo-svg-tree-config-builder';


// =====  tree  =====
export const edgeData: BoSvgLink[] = [
  {
    id: 'a',
    source: '1',
    target: '2',
