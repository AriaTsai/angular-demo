import { Graph, Layout, Edge, ClusterNode, Orientation, Alignment, DagreSettings, DagreNodesOnlySettings } from '@swimlane/ngx-graph';
...
export class BoSvgLayout implements Layout {
